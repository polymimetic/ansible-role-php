...
[![Build Status](https://img.shields.io/travis/polymimetic/ansible-role-php.svg?style=flat-square)](https://travis-ci.org/polymimetic/ansible-role-php)
[![Release](https://img.shields.io/github/tag/polymimetic/ansible-role-php.svg?style=flat-square)](https://github.com/polymimetic/ansible-role-php/releases)
...
[![Ansible Galaxy](https://img.shields.io/badge/galaxy-polymimetic.php-blue.svg?style=flat-square)](https://galaxy.ansible.com/polymimetic/php/)
...
By default, this is set to 'installed'. You can now override this variable to 'latest'. Combined with php_enablerepo, a user now doesn't need to manually uninstall the existing PHP packages before installing them from a different repository.
...
* ansible-role-php generated using [ansible-role-skeleton](https://github.com/polymimetic/ansible-role-skeleton)